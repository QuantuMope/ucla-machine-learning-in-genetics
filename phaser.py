...
def clarks_algo(data, num_individuals, num_snps, num_blocks, block_size):
    ...
    full_match, half_match, no_match = 0, 0, 0
    for b in range(num_blocks):
        ...
        for i in range(num_individuals):
            ...
            for haplo in unique_haplos:
                ...
                if not np.any(potential_haplo == 2) and not np.any(potential_haplo == -1):
                    ...
                    phased_haplotypes[2*i, h1s:h1e] = haplo
                    phased_haplotypes[2*i+1, h1s:h1e] = potential_haplo
                    found_match = True
                    break
        ...
        # print('full_match: {}'.format(full_match))
        # print('half_match: {}'.format(half_match))
        # print('no_match: {}'.format(no_match))
...
def main():
    ...
    print(phased_haplotypes.T.shape)
